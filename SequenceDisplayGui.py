...
class Ui_SequenceDisplayWnd(object):
    def setupUi(self, SequenceDisplayWnd):
        ...
        self.actionSave_current_frame = QtGui.QAction(SequenceDisplayWnd)
        ...
        self.menuOutput.addSeparator()
        self.menuOutput.addAction(self.actionSave_current_frame)
        self.menuOutput.addAction(self.actionSave_decorations_as_mask)
    ...
    def retranslateUi(self, SequenceDisplayWnd):
        ...
        self.menuDatabase.setTitle(_translate("SequenceDisplayWnd", "Data&base", None))
        self.menuStacks.setTitle(_translate("SequenceDisplayWnd", "St&ack", None))
        ...
        self.menuOutput.setTitle(_translate("SequenceDisplayWnd", "O&utput", None))
        ...
        self.actionSubtract_image.setText(_translate("SequenceDisplayWnd", "S&ubtract image", None))
        self.actionDivide_by_image.setText(_translate("SequenceDisplayWnd", "Divide &by image", None))
        self.actionMultiply_by_image.setText(_translate("SequenceDisplayWnd", "Mu&ltiply by image", None))
        ...
        self.actionSave_as_avi.setText(_translate("SequenceDisplayWnd", "Sa&ve as avi", None))
