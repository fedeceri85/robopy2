...
class Ui_ProcessOptionsDlg(object):
    def setupUi(self, ProcessOptionsDlg):
        ...
        ProcessOptionsDlg.resize(520, 460)
        self.gridLayout_3 = QtGui.QGridLayout(ProcessOptionsDlg)
        ...
        self.referenceFramesLabel_3 = QtGui.QLabel(self.FrameOptionsTab)
        self.referenceFramesLabel_3.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.referenceFramesLabel_3.setObjectName(_fromUtf8("referenceFramesLabel_3"))
        self.horizontalLayout_24.addWidget(self.referenceFramesLabel_3)
        self.progressiveDiffSpinBox = QtGui.QSpinBox(self.FrameOptionsTab)
        self.progressiveDiffSpinBox.setMinimum(0)
        self.progressiveDiffSpinBox.setMaximum(99999)
        self.progressiveDiffSpinBox.setProperty("value", 0)
        self.progressiveDiffSpinBox.setObjectName(_fromUtf8("progressiveDiffSpinBox"))
        self.horizontalLayout_24.addWidget(self.progressiveDiffSpinBox)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 30, 347, 84))
        ...
        self.horizontalLayout_22 = QtGui.QHBoxLayout(self.DOgroupBox)
        self.horizontalLayout_22.setObjectName(_fromUtf8("horizontalLayout_22"))
        self.verticalLayout_4 = QtGui.QVBoxLayout()
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.horizontalLayout_4 = QtGui.QHBoxLayout()
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.LUTradioButton = QtGui.QRadioButton(self.DOgroupBox)
        ...
        self.HSVradioButton = QtGui.QRadioButton(self.DOgroupBox)
        ...
        self.medianFilterCheckbox = QtGui.QCheckBox(self.DOgroupBox)
        ...
        self.gaussianFilterCheckbox = QtGui.QCheckBox(self.DOgroupBox)
        ...
        self.label_8 = QtGui.QLabel(self.DOgroupBox)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.horizontalLayout_21.addWidget(self.label_8)
        self.gammaHSpinBox = QtGui.QDoubleSpinBox(self.DOgroupBox)
        ...
        self.verticalLayout_11.addWidget(self.displayTimesCheckBox)
        ...
        self.textOnScalebarCheckBox = QtGui.QCheckBox(self.tab)
        self.textOnScalebarCheckBox.setEnabled(True)
        self.textOnScalebarCheckBox.setChecked(False)
        self.textOnScalebarCheckBox.setObjectName(_fromUtf8("textOnScalebarCheckBox"))
        self.horizontalLayout_27.addWidget(self.textOnScalebarCheckBox)
        ...
        self.verticalLayout_14 = QtGui.QVBoxLayout(self.RoiOptionsTab)
        self.verticalLayout_14.setObjectName(_fromUtf8("verticalLayout_14"))
        self.groupBox_2 = QtGui.QGroupBox(self.RoiOptionsTab)
        self.groupBox_2.setObjectName(_fromUtf8("groupBox_2"))
        self.verticalLayout_13 = QtGui.QVBoxLayout(self.groupBox_2)
        self.verticalLayout_13.setObjectName(_fromUtf8("verticalLayout_13"))
        self.horizontalLayout_20 = QtGui.QHBoxLayout()
        self.horizontalLayout_20.setObjectName(_fromUtf8("horizontalLayout_20"))
        self.rectangularRoisCheckBox = QtGui.QCheckBox(self.groupBox_2)
        self.rectangularRoisCheckBox.setObjectName(_fromUtf8("rectangularRoisCheckBox"))
        self.buttonGroup = QtGui.QButtonGroup(ProcessOptionsDlg)
        self.buttonGroup.setObjectName(_fromUtf8("buttonGroup"))
        self.buttonGroup.addButton(self.rectangularRoisCheckBox)
        ...
        self.roiSizeSpinBox = QtGui.QSpinBox(self.groupBox_2)
        ...
        self.semicircularRoisCheckBox = QtGui.QCheckBox(self.groupBox_2)
        ...
        self.verticalLayout_13.addWidget(self.semicircularRoisCheckBox)
        self.polygonalRoisCheckBox = QtGui.QCheckBox(self.groupBox_2)
        ...
        self.verticalLayout_13.addWidget(self.polygonalRoisCheckBox)
        self.freehandRoisCheckBox = QtGui.QCheckBox(self.groupBox_2)
        ...
        self.verticalLayout_13.addWidget(self.freehandRoisCheckBox)
        self.verticalLayout_14.addWidget(self.groupBox_2)
        spacerItem8 = QtGui.QSpacerItem(20, 66, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.verticalLayout_14.addWidget(self.roiSameSizeCheckBox)
        spacerItem9 = QtGui.QSpacerItem(20, 65, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.subBackCheckBox.setObjectName(_fromUtf8("subBackCheckBox"))
        self.horizontalLayout_26.addWidget(self.subBackCheckBox)
        self.subBackLineEdit = QtGui.QLineEdit(self.RoiOptionsTab)
        self.subBackLineEdit.setEnabled(False)
        self.subBackLineEdit.setObjectName(_fromUtf8("subBackLineEdit"))
        self.horizontalLayout_26.addWidget(self.subBackLineEdit)
        self.verticalLayout_14.addLayout(self.horizontalLayout_26)
        self.groupBox = QtGui.QGroupBox(self.RoiOptionsTab)
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.verticalLayout_12 = QtGui.QVBoxLayout(self.groupBox)
        self.verticalLayout_12.setObjectName(_fromUtf8("verticalLayout_12"))
        self.verticalLayout = QtGui.QVBoxLayout()
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.autoColorRadioButton = QtGui.QRadioButton(self.groupBox)
        self.autoColorRadioButton.setChecked(True)
        self.autoColorRadioButton.setObjectName(_fromUtf8("autoColorRadioButton"))
        self.buttonGroup_2 = QtGui.QButtonGroup(ProcessOptionsDlg)
        self.buttonGroup_2.setObjectName(_fromUtf8("buttonGroup_2"))
        self.buttonGroup_2.addButton(self.autoColorRadioButton)
        self.verticalLayout.addWidget(self.autoColorRadioButton)
        self.horizontalLayout_28 = QtGui.QHBoxLayout()
        self.horizontalLayout_28.setObjectName(_fromUtf8("horizontalLayout_28"))
        self.setColorradioButton = QtGui.QRadioButton(self.groupBox)
        self.setColorradioButton.setObjectName(_fromUtf8("setColorradioButton"))
        self.buttonGroup_2.addButton(self.setColorradioButton)
        self.horizontalLayout_28.addWidget(self.setColorradioButton)
        self.chooseColorButton = QtGui.QPushButton(self.groupBox)
        ...
        self.chooseColorButton.setPalette(palette)
        self.chooseColorButton.setObjectName(_fromUtf8("chooseColorButton"))
    ...
    def retranslateUi(self, ProcessOptionsDlg):
        ...
        self.referenceFramesLabel_3.setText(_translate("ProcessOptionsDlg", "Progressive differences", None))
        ...
        self.userInterframeRadioButton.setText(_translate("ProcessOptionsDlg", "Specif&y interframe time interval (ms)", None))
        ...
        self.ColorMapcomboBox.setItemText(1, _translate("ProcessOptionsDlg", "Gray", None))
        self.ColorMapcomboBox.setItemText(2, _translate("ProcessOptionsDlg", "RedHot", None))
        ...
        self.FrameByFrameRadioButton.setText(_translate("ProcessOptionsDlg", "Frame b&y frame", None))
        self.NomarskiRadioButton.setText(_translate("ProcessOptionsDlg", "Nomars&ki", None))
        ...
        self.textOnScalebarCheckBox.setText(_translate("ProcessOptionsDlg", "Display text on scalebar", None))
        ...
        self.groupBox_2.setTitle(_translate("ProcessOptionsDlg", "Roi shape", None))
